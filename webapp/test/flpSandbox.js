		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsampleresourcemodelstudy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsampleresourcemodelstudy-display": {
								"semanticObject": "comsampleresourcemodelstudy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sample.resourcemodelstudy",
									"url": sap.ui.require.toUrl("com/sample/resourcemodelstudy")
								}
							}
						}
					}
